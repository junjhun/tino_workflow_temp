...
ActiveRecord::Schema[7.0].define(version: 2025_09_28_071900) do
  ...
  create_table "shirts", force: :cascade do |t|
    ...
    t.integer "collar_style", default: 0, null: false
    ...
    t.boolean "with_flap", default: false
    t.integer "front_pocket_flap"
    t.integer "sleeve_length"
    t.boolean "buttoned_down", default: false
    t.boolean "buttoned_down_with_loop", default: false
  ...
  create_table "vests", force: :cascade do |t|
    ...
    t.string "fabric_code"
    t.string "lining_code"
    t.integer "vest_model", default: 0, null: false
    t.integer "fabric_label"
    t.string "lapel_width"
    t.integer "fabric"
