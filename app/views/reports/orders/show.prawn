    ...
    if @report == "Master" || @report == "Shirts"
      ...
      @shirts.each_with_index do |shirt, index|
        ...
        cbody = [
          ...
          [{content: "Fabric label: #{shirt&.fabric_label}", colspan: 2}, {content: "Tafetta: #{shirt&.tafetta}", colspan: 2 }, {content: "Jacket length: #{coat&.jacket_length}", colspan: 2}, {content: "Brand label: #{shirt&.brand_label}", colspan: 2}, {content: "Number of buttons: #{shirt&.number_of_buttons}", colspan: 2} ],
