    ...
    tabs do
      ...
      if order.coats.any?
        tab 'Coat Style' do
          ...
          panel 'Coat Subsection 3 with Images' do
            table_for order.coats, class: 'responsive-image-table' do
              ...
              # lapel_style
              column "Lapel", style: "text-align: center;" do |coat|
                content_html = ""
                if (image_path = coat.coat_lapel_style_image_asset_path)
                  content_html << image_tag(image_path, size: "100x100", alt: coat.lapel_style.humanize, style: "display: block; margin: 0 auto; min-width: 100px;")
                end
                content_html << tag.div(
                  (coat.lapel_style.blank? ? "N/A" : coat.lapel_style.humanize),
                  style: "text-align: center; margin-top: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
                )
                content_html.html_safe
              end
              ...
              # vent
              column "Vent", style: "text-align: center;" do |coat|
                content_html = ""
                if (image_path = coat.coat_vent_image_asset_path)
                  content_html << image_tag(image_path, size: "100x100", alt: coat.vent.humanize, style: "display: block; margin: 0 auto; min-width: 100px;")
                end
                content_html << tag.div(
                  (coat.vent.blank? ? "N/A" : coat.vent.humanize),
                  style: "text-align: center; margin-top: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
                )
                content_html.html_safe
              end
              ...
              # lining
              column "Lining", style: "text-align: center;" do |coat|
                content_html = ""
                if (image_path = coat.coat_lining_image_asset_path)
                  content_html << image_tag(image_path, size: "100x100", alt: coat.lining.humanize, style: "display: block; margin: 0 auto; min-width: 100px;")
                end
                content_html << tag.div(
                  (coat.lining.blank? ? "N/A" : coat.lining.humanize),
                  style: "text-align: center; margin-top: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
                )
                content_html.html_safe
              end
              ...
              # pocket_type
              column "Pocket Type", style: "text-align: center;" do |coat|
                content_html = ""
                if (image_path = coat.coat_chest_pocket_image_asset_path)
                  content_html << image_tag(image_path, size: "100x100", alt: coat.pocket_type.humanize, style: "display: block; margin: 0 auto; min-width: 100px;")
                end
                content_html << tag.div(
                  (coat.pocket_type.blank? ? "N/A" : coat.pocket_type.humanize),
                  style: "text-align: center; margin-top: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
                )
                content_html.html_safe
              end
          ...
          # --- END: Shirt Subsection 3 with Images ---
      ...
      if order.shirts.any?
        tab 'Shirt' do
          if current_user.role.in?(['Administrator', 'Master Tailor', 'Sales Assistant', 'Production Manager', 'Vest Maker'])
            ...
            # --- START: Shirt Subsection 3 with Images ---
            panel 'Shirt Subsection 3 with Images' do
              table_for order.shirts, class: 'responsive-image-table' do
                column "Collar Style", style: "text-align: center;" do |shirt| # Centered header
                  content_html = ""
                  if (image_path = shirt.collar_style_image_asset_path)
                    content_html << image_tag(image_path, size: "100x100", alt: shirt.collar_style.humanize, style: "display: block; margin: 0 auto; min-width: 100px;")
                  end
                  # Text: wrapped in div, centered, with small top margin
                  content_html << tag.div(
                    (shirt.collar_style.blank? ? "N/A" : shirt.collar_style.humanize),
                    style: "text-align: center; margin-top: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
                  )
                  content_html.html_safe # Render as HTML
                end

                column "Sleeves", style: "text-align: center;" do |shirt| # Centered header
                  content_html = ""
                  if (image_path = shirt.sleeves_image_asset_path)
                    content_html << image_tag(image_path, size: "100x100", alt: shirt.sleeves.humanize, style: "display: block; margin: 0 auto; min-width: 100px;")
                  end
                  content_html << tag.div(
                    (shirt.sleeves.blank? ? "N/A" : shirt.sleeves.humanize),
                    style: "text-align: center; margin-top: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
                  )
                  content_html.html_safe
                end

                column "Cuffs", style: "text-align: center;" do |shirt| # Centered header
                  content_html = ""
                  if (image_path = shirt.cuffs_image_asset_path)
                    content_html << image_tag(image_path, size: "100x100", alt: shirt.cuffs.humanize, style: "display: block; margin: 0 auto; min-width: 100px;")
                  end
                  content_html << tag.div(
                    (shirt.cuffs.blank? ? "N/A" : shirt.cuffs.humanize),
                    style: "text-align: center; margin-top: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
                  )
                  content_html.html_safe
                end

                column "Pocket", style: "text-align: center;" do |shirt| # Centered header
                  content_html = ""
                  if (image_path = shirt.pocket_image_asset_path)
                    content_html << image_tag(image_path, size: "100x100", alt: shirt.pocket.humanize, style: "display: block; margin: 0 auto; min-width: 100px;")
                  end
                  content_html << tag.div(
                    (shirt.pocket.blank? ? "N/A" : shirt.pocket.humanize),
                    style: "text-align: center; margin-top: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
                  )
                  content_html.html_safe
                end
